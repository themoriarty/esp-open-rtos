...
typedef struct{
	...
	int RootCALen;				///< Pointer to string containing the filename (including path) of the root CA file.
	const unsigned char* DeviceCert;
	int DeviceCertLen;			///< Pointer to string containing the filename (including path) of the device certificate.
	const unsigned char* DevicePrivateKey;
	int DevicePrivateKeyLen;	///< Pointer to string containing the filename (including path) of the device private key file.
