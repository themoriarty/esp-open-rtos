...
IoT_Error_t aws_iot_mqtt_connect(MQTTConnectParams *pParams) {
	...
	TLSParams.DeviceCert = pParams->DeviceCert;
        TLSParams.DeviceCertLen = pParams->DeviceCertLen;
	TLSParams.DevicePrivateKey = pParams->DevicePrivateKey;
        TLSParams.DevicePrivateKeyLen = pParams->DevicePrivateKeyLen;
	TLSParams.RootCA = pParams->RootCA;
        TLSParams.RootCALen = pParams->RootCALen;
