...
MQTTReturnCode MQTTClient(Client *c, uint32_t commandTimeoutMs,
    ...
    c->tlsConnectParams.DeviceCert = tlsConnectParams->DeviceCert;
    c->tlsConnectParams.DeviceCertLen = tlsConnectParams->DeviceCertLen;
    c->tlsConnectParams.DevicePrivateKey = tlsConnectParams->DevicePrivateKey;
    c->tlsConnectParams.DevicePrivateKeyLen = tlsConnectParams->DevicePrivateKeyLen;
    c->tlsConnectParams.RootCA = tlsConnectParams->RootCA;
    c->tlsConnectParams.RootCALen = tlsConnectParams->RootCALen;
